...
<dependency>
    ...
    <version>${lajpms-eclipse-collections-api-version}</version>
</dependency>
```

Add the following dependency to your build.gradle:
```groovy
implementation 'dev.ikm.jpms:antlr4-runtime:${lajpms-eclipse-collections-api-version}'
```
